...
export default function ApplicntSinin() {
    ...
    const login = async (e) => {
        ...
        try {
            ...
            if (response.data) {
                ...
                navigate(`/dash/${data.id}/applicant/generaldata`)
            } else {
    ...
    const sinup = () => {
        navigate("/dash/applicant/applicntsinup")
    }
                ...
                <div class="forms-container">
                    <div class="signin-signup">
                        <form action="#" class="sign-in-form">
                            <h2 class="title"> Applicents Sign in</h2>
                ...
                <div class="panels-container">
                    <div class="panel left-panel">
                        <div class="content mt-8" >
                            <h3 className='mb-5'>WellCome to Applicents sinin Page</h3>
                            <p className='mb-5'>
